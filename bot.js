...
client.on("message", async message => {
  ...
  if (!kelime) {
    message.react("<<a:verif_black:845695003308195862>");
...
client.on("guildMemberAdd", member => {
  ...
  let kontrol;
  if (süre < 1296000000)
    kontrol = "<a:verif_black:845695003308195862> `Bu hesap şüpheli!`";
  if (süre > 1296000000)
    kontrol = "<a:verif_black:845695003308195862> `Bu hesap güvenli!`";
  ...
  let codare = new Discord.MessageEmbed()
    ...
    .setDescription(
      "<@" +
        member.id +
        "> Bilgileri  \n\n <a:zil:853659816786133022> __Hesap Oluşturulma Tarihi__  \n\n**[" +
        created +
        "]** (`" +
        günay +
        "`) \n\n <a:zil:853659816786133022> __Hesap durumu__ \n\n**" +
        kontrol +
        "**"
    );
