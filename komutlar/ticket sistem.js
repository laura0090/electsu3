...
exports.run = async(client, message, args) => { 
  let prefix = (await db.fetch(`prefix_${message.guild.id}`)) || "${prefix}";
    ...
    const embed = new Discord.MessageEmbed()
        ...
        .setColor('black')
       .setTitle(`**Electus Ticket Sistemi Menüsüne Hoşgeldin** `)
        .setDescription(`	
	**<a:zil:853659816786133022>  Prefixim \`\`\.\`\`\


  ** <a:maviyldz:853659864525307904>  ${ayarlar.prefix}ticket-kapat**  Ticketi 5 saniyede siler.

  ** <a:maviyldz:853659864525307904>  ${ayarlar.prefix}ticket-kanal**  Ticket Gittiği Kanalı Ayarlar.

  ** <a:maviyldz:853659864525307904>  ${ayarlar.prefix}ticket-kaldır**  Ticket Kanalını Kaldırır.

  ** <a:maviyldz:853659864525307904>  ${ayarlar.prefix}ticket-ekle**  Ticket Ekler.

  ** <a:maviyldz:853659864525307904>  ${ayarlar.prefix}ticket-aç**  Ticket Açar.
