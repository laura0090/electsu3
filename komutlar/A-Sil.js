...
return message.channel.send(new Discord.MessageEmbed().setTitle('<a:verif_black:845695003308195862> İşte bu kadar! '+`${args[0]}`+' adet mesaj silindi')).then(m => m.delete({timeout: 5000}));
};
exports.conf = {
  enabled: true,
  guildOnly: true,
