...
exports.run = async(client, message, args) => { 
  let prefix = (await db.fetch(`prefix_${message.guild.id}`)) || "${prefix}";
    ...
    const embed = new Discord.MessageEmbed()
        ...
        .setColor('black')
       .setTitle(`**Electus Yardım Menüsüne Hoşgeldin** `)
        .setDescription(`	
	**<a:zil:853659816786133022>  Prefixim \`\`\.\`\`\


  ** <a:maviyldz:853659864525307904>  ${ayarlar.prefix}genel**  Genel Komutlarını Gösterir.

  ** <a:maviyldz:853659864525307904>  ${ayarlar.prefix}kullanıcı**  Kullanıcı Komutlarını Gösterir.

  ** <a:maviyldz:853659864525307904>  ${ayarlar.prefix}eğlence**  Eğlence Komutlarını Gösterir.

  ** <a:maviyldz:853659864525307904>  ${ayarlar.prefix}eklenti**  Eklenti Komutlarını Gösterir.
